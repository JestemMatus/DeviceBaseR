...
<div class="content">
    <div class="box">
        ...
        <form action="<c:url value='/changePassword' />" method="post">
            ...
            <button type="button" onclick="goBack()" id="back-button" data-user-id="${user.id}">Cofnij</button>
        </form>
    </div>
</div>
...
<script>
    ...
    function goBack() {
        const userId = document.getElementById('back-button').getAttribute('data-user-id');
        window.location.href = '/editUser/' + userId;
    }
</script>
</body>
